...
$EMAIL_SUBJECT = 'SQL Backup for Discrete Events ' . date('Y-m-d') . ' at ' . date('H:i');

// The destination address for the backup email
$EMAIL_ADDR = 'chandusmysqlbackups@gmail.com';
